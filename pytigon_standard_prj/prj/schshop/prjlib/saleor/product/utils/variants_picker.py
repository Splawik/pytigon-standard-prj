...
# SCH++
#from big_company.product import ProductVariantProxy
from big_company.queryset_proxy import ProductVariantProxy
# SCH--
...
def get_variant_picker_data(
    ...
    #variants = ProductVariantProxy(product.variants).all()
    variants = product.variants2.all()
    #SCH--
