...
#SCH++
#from sync.urls import urlpatterns as sync_urls
from big_company.urls import urlpatterns as big_company_urls
#from extra.urls import urlpatterns as extra_urls
#SCH--
...
#SCH++
    #url(r'^sync/',  include((sync_urls, 'sync'), namespace='sync')),
    url(r'^big_company/',  include((big_company_urls, 'big_company'), namespace='big_company')),
    #url("",  include((extra_urls, 'extra'), namespace='extra')),
