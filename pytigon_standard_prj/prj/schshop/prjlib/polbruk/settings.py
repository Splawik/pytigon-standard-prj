...
#        "pos_id": "392426",
#        "second_key": "b0cee05c345f07a8695ccc116c238114",
#        "oauth_id": "392426",
#        "oauth_secret": "88daa612c2775a35da182b46ba707bcd",
#    },
#}
...
DATABASES = {
    "default": dj_database_url.config(
        #default="postgres://postgres:Barakuda2019@10.48.201.97:5432/polbruk_saleor1", conn_max_age=600
        #default="postgres://shop:W@rszawa2020@sklep.polbruk.pl:5432/polbruk_sklep", conn_max_age=600
        #default="postgres://postgres:2020W@rszawa@sklep.polbruk.pl:5432/polbruk_sklep2", conn_max_age=600
        default="postgres://postgres:2Kangury@10.48.201.98:5432/polbruk_sklep2", conn_max_age=600
    )
}
# SCH--
...
#SCH++        
        ...
        "DIRS": [os.path.join(PROJECT_ROOT, "ext_lib", "templates"), os.path.join(PROJECT_ROOT, "templates")],
#SCH--        
        "OPTIONS": {
            "debug": DEBUG,
