...
PRJ_TITLE = "EPG"
PRJ_NAME = "schepg"
THEMES = ["smartfon_modern", "smartfon_standard", "smartfon_standard"]
...
DATE_INPUT_FORMATS = ("%Y-%m-%d %H:%M %Z", "%Y%m%d%H%M%S %Z")
GUI_COMMAND_LINE = "-b --embededtaskqueue"
from pytigon_lib.schtools.install_init import init

init(PRJ_NAME, ROOT_PATH, DATA_PATH, PRJ_PATH, STATIC_ROOT, [MEDIA_ROOT, UPLOAD_PATH])

START_PAGE = "./epg/table/Epg/-/form/list/"
SHOW_LOGIN_WIN = True
PACKS = []
